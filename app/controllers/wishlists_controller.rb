...
class WishlistsController < ApplicationController
  ...
  def create
    ...
    if result.success?
      ...
      render turbo_stream: turbo_stream.replace(:wishlist_form_frame, partial: 'wishlists/form', locals: { wishlist: new_wishlist(wishlist_params), errors: ErrorsHelper::SimpleFormError.new.call(result) })
    end
  end
  ...
  def update
    ...
    if result.success?
      ...
      render turbo_stream: turbo_stream.replace(:wishlist_form_frame, partial: 'wishlists/form', locals: { wishlist: @wishlist, errors: ErrorsHelper::SimpleFormError.new.call(result) })
    end
  end
  ...
  def destroy
    ...
    if result.success?
      ...
      redirect_to wishlists_path, notice: ErrorsHelper::AlertError.new.call(result)
    end
  end
